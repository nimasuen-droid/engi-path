...
export const SCENARIOS: Scenario[] = [
  {
    ...
    category: "Codes",
    description:
      'A new 36" gas transmission line, onshore Class 2. Select the governing design code.',
    steps: [
      {
        ...
        options: [
          { label: "ASME B31.4", correct: false, feedback: "B31.4 covers liquid hydrocarbons." },
          {
            label: "ASME B31.8",
            correct: true,
            feedback: "Correct — gas transmission falls under B31.8.",
          },
          {
            label: "API 1160",
            correct: false,
            feedback: "API 1160 is integrity management for liquids.",
          },
          {
            label: "DNV-ST-F101",
            correct: false,
            feedback: "DNV-ST-F101 governs subsea pipelines.",
          },
        ],
      },
    ],
    ...
    steps: [
      {
        ...
        options: [
          ...
          {
            label: "No, retest required",
            correct: true,
            feedback: "Correct — minimum 1.25 × MAOP = 10.0 MPa.",
          },
          {
            label: "Yes if engineer signs off",
            correct: false,
            feedback: "Code minimum is not waivable by signature.",
          },
        ],
      },
    ],
